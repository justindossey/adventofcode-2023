...
local function fivex_string(str)
  local out = str
  for i=1, 4 do
    out = out .. "?" .. str
  end
...
local function fivex_group(group)
  local out = {}
  for i=1, 5 do
